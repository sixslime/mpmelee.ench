...
execute store result score *enchant.level -mpmelee.ench run data get storage mpmelee.ench:var get_weapon.result.components."minecraft:enchantments".levels."mpmelee.ench:melee/fleeting"
